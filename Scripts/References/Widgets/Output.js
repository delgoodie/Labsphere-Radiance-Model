class Output {
    constructor(_top, _parent, _id = -1, _classes = {}, _updateValue = () => {}) {
        ...
        this.params = [new Parameter(this.top, this.element, { container: 'output-parameter', dropfield: 'output-param-div', field: 'output-param-div' }, 'CCT', Parameter.DOWN),
            ...
            new Parameter(this.top, this.element, { container: 'output-parameter', dropfield: 'output-param-div', field: 'output-param-div' }, 'cd/m2', Parameter.DOWN),
            new Parameter(this.top, this.element, { container: 'output-parameter', dropfield: 'output-param-div', field: 'output-param-div' }, 'fL', Parameter.DOWN),
